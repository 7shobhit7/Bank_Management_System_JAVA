...
public class SignUpTwo extends  JFrame implements  ActionListener{
    ...
    {  
        JFrame frame = new JFrame("APPLICATION FORM PAGE 2");
        frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
         frame.setContentPane(new Login.ImagePanel(new ImageIcon(getClass().getResource("/icons/w.png")).getImage()));
       ...
       enforceMinimumFrameSize(frame,700,850);
        ...
        formNumber=new JLabel("APPLICATION DETAILS FORM 2 :");
...
//    JButton Clear_Button,Next_button;
    ...
    {
        SwingUtilities.invokeLater(SignUpTwo::new);
    }
